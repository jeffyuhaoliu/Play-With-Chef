...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jeffyuhaoliu-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jeffyuhaoliu"
  #   chef.validation_client_name = "jeffyuhaoliu-validator"
  #   chef.validation_key_path = ".chef/jeffyuhaoliu-validator.pem"
  # end
end
